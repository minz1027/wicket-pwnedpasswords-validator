...
In this example, we set some variables in our `sonar-project.properties` file. These will be used by SonarQube to generate code coverage results and code analysis.
